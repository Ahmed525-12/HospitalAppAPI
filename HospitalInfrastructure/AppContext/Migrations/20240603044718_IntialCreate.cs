        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Session_History_HistoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Department_History_HistoryId",
                        column: x => x.HistoryId,
                        principalTable: "History",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Department_History_HistoryId1",
                        column: x => x.HistoryId1,
                        principalTable: "History",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Department_Session_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Session",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Department_Session_SessionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Medicines_Pharmacy_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "Pharmacy",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Medicines_Reports_ReportsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Category_Medicines_MedicinesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Category_MedicinesId",
                table: "Category",
                column: "MedicinesId");

            migrationBuilder.CreateIndex(
                name: "IX_Department_HistoryId",
                table: "Department",
                column: "HistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Department_HistoryId1",
                table: "Department",
                column: "HistoryId1");

            migrationBuilder.CreateIndex(
                name: "IX_Department_SessionId",
                table: "Department",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_Department_SessionId1",
                table: "Department",
                column: "SessionId1");

            migrationBuilder.CreateIndex(
                name: "IX_Medicines_OrdersId",
                table: "Medicines",
                column: "OrdersId");
